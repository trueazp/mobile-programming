...
import com.miaowmere.finalproject_h071191035.data.local.FavoriteHelper;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private void onBindView(TvShow tvShow) {
        ...
        Glide.with(this).load(tvShow.getBackdropPath(ImageSize.W500)).into(ivBackdrop);
        Glide.with(this).load(tvShow.getPosterPath(ImageSize.W154)).into(ivPoster);
