package com.miaowmere.finalproject_h071191035.activities;
...
import com.miaowmere.finalproject_h071191035.fragments.FavoriteFragment;
import com.miaowmere.finalproject_h071191035.fragments.MovieFragment;
import com.miaowmere.finalproject_h071191035.fragments.TvShowFragment;
...
public class MainActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private void setActionBarTitle(String title) {
        ...
        String first = title.substring(0,2);
        String end = title.substring(2,title.length());
